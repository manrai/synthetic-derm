...
def parse_args():
    ...
    parser.add_argument(
        "--checkpointing_steps",
        type=int,
        default=1_000_000,  # 500  # <- disable for now
        help=(
    ...
    # Copied from train_dreambooth.py
    parser.add_argument(
        "--allow_tf32",
        action="store_true",
        help=(
...
def main():
    ...
    def collate_fn(examples):
        ...
        if args.with_prior_preservation:
            ...
            pior_pil = [to_pil_image(example["class_instance_images"] * 0.5 + 0.5) for example in examples]
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("derm", config=vars(args))
